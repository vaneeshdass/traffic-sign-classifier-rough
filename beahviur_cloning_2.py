...
with open('./CarND-Behavioral-Cloning-P3/data/driving_log.csv') as csvfile: #currently after extracting the file is present in this path
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                for i in range(0, 3):  # we are taking 3 images, first one is center, second is left and third is right
                    ...
                    name = './CarND-Behavioral-Cloning-P3/data/IMG/' + batch_sample[i].split('/')[-1]
            ...
            yield sklearn.utils.shuffle(X_train,
                                        y_train)  # here we do not hold the values of X_train and y_train instead we yield the values which means we hold until the generator is running
